...
import './tutorrecentActivity.css';
import TutorRecentActivityItem from './TutorRecentActivityItem';

function TutorRecentActivity() {
      ...
      <div className="card-body">
        ...
        <div className="activity">
          {items &&
            items.length > 0 &&
            items.map(item => (
              <TutorRecentActivityItem key={item._id} item={item} />
            ))}
        </div>
      </div>
    </div>
...
export default TutorRecentActivity;
